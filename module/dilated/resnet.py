...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1, dilated=True, norm_layer=nn.BatchNorm2d, multi_grid=False, multi_dilation=None):
        self.inplanes = 64
...
def resnet50(pretrained=False, root='./pretrain_models', **kwargs):
    ...
    if pretrained:
        ...
        for k, v in pretrained_dict.items():
            if k in model_dict:
                model_dict_temp[k] = v
        model_dict.update(model_dict_temp)
